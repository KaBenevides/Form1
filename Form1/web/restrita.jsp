...
<html>
    ...
    <body>               
        ...
        <div class="row mt-4 mb-4">
            ...
            <button type="button" class="btn-info" data-toggle="modal" data-target="#modalInserir"> Inserir um Novo Usuário </button>
            <form class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-2" type="search" name="txtbuscar" placeholder="Digite seu nome: " aria-label="Search">
